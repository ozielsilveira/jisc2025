            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <AnimatedSection>
                <div>
                  ...
                  <h2 className="text-3xl md:text-4xl font-display font-bold mb-6 tracking-wide text-white">Sobre o JISC</h2>
                      ...
                      <ul className="space-y-4">
                        <li className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-white/70">
                              Mais de 20 modalidades esportivas e culturais
                            </p>
                          </div>
                        </li>
                        <li className="flex items-start">
                        ...
                        <li className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-white/70">
                              Networking com estudantes de diversas áreas
                            </p>
                          </div>
                        </li>
                      </ul>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              <AnimatedSection>
                <div>
                  ...
                  <h2 className="text-3xl md:text-4xl font-display font-bold mb-6 tracking-wide text-white">Entre em Contato</h2>
